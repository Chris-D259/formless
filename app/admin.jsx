...
export default function Admin() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.openingText}>Welcome Admin!</Text>
      <Text className='text-2xl'>What would you like to do Today?</Text>
      ...
      <View style={styles.containerNav}>
        <View style={styles.navButton}>
          ...
          <Text style={styles.navButtonText}>All Reports</Text>
        </View>
        <View style={styles.navButton}>
        <Image style={styles.navImages}source={require('../assets/images/submissions.png')} />
          <Text style={styles.navButtonText}>All Submissions</Text>
        </View>
        <View style={styles.navButton}>
